...
QString CTVariable::information() const {
    ...
    if (variable == "HOME") {
        return QObject::tr("Override default home folder.");
    } else if (variable == "MAILTO") {
        return QObject::tr("Email output to specified account.");
    } else if (variable == "SHELL") {
        return QObject::tr("Override default shell.");
    } else if (variable == "PATH") {
        return QObject::tr("Folders to search for program files.");
    } else if (variable == "LD_CONFIG_PATH") {
        return QObject::tr("Dynamic libraries location.");
    }

    return QObject::tr("Local Variable");
